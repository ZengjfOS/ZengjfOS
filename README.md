...
0005 | [batTool](https://github.com/ZengjfOS/batTool)                           | Windows cmd命令对adb工具封装
0006 | [UART Tool](https://github.com/ZengjfOS/UartRS)                          | Linux/Android的命令行串口调试工具
0007 | [V4L2](https://github.com/ZengjfOS/V4L2)                                 | 分析V4L2的架构，其中包括显示部分和摄像头部分
0008 | [ASoC](https://github.com/ZengjfOS/ASoC)                                 | 分析i.MX6 CS42888 ASoC驱动工作原理
0009 | [Modbus Protocol](https://github.com/ZengjfOS/Modbus_TCP)                | Modbus协议分析
0010 | [MQTT Protocol](https://github.com/ZengjfOS/MQTTClient4Android)          | MQTT通信协议貌似已经成为标准的物联网通信协议了
...
0013 | [Yocto](https://github.com/ZengjfOS/Yocto)                               | 分析Yocto编译原理，能做的事情和Buildroot类似，不过更重要的是芯片大厂都参与维护，知名度更高；
0014 | [Buildroot](https://github.com/ZengjfOS/Buildroot)                       | 也许Busybox是很不错的学习文件系统的工具，不过Buildroot会让你惊讶于不止于Busybox；
0015 | [i2cReg](https://github.com/ZengjfOS/i2cReg)                             | 依赖于i2c-tools，i2c设备寄存器读写工具，含Android、Linux版本
0016 | [SD Card Image](https://github.com/ZengjfOS/mksdimg)                     | SD/EMMC tar解包部署文件系统太慢，SD卡image文件直接dd更高效；
0017 | [Tmux](https://github.com/ZengjfOS/Tmux)                                 | 个人Tmux配置
0018 | <li>[PyHTTP](https://github.com/ZengjfOS/PyHTTP)<br><li>[GoHTTP](https://github.com/ZengjfOS/GoHTTP)      | Python、Golang Web工具尝试，不擅长UI，效果貌似不好
